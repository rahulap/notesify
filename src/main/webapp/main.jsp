...
<html>
	...
	<div id="toptext" style="float:left;display:inline-block"> <button id="submit" onClick="displaymsg()">Inbox <div id="inbox" style="float:left;display:inline-block"><%=i%></div></button></div>
